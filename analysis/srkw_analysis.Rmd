...
The counts of Snake River spring Chinook at Lower Granite Dam come from [Columbia Basin Research](http://www.cbr.washington.edu/dart/query/adult_annual_sum). I'll devide them by 1000 to make them more similar in magnitude to the SRKW data.
...
## orcas
matplot(kw[,1], kw[,-1], type="l", lty="solid",
        xlab = "", ylab = "Count", col = viridis::viridis(4, end = 0.8))
text(2018,kw[nrow(kw),-1],c("J","K","L","All"), cex=0.7, col = viridis::viridis(4, end = 0.8))
mtext("Southern resident killer whales", 3, adj=0, line=0.5)
## salmon
matplot(ss[,1], ss[,2], type="l", lty="solid",
     xlab = "Year", ylab = "Count", col = viridis::viridis(1))
